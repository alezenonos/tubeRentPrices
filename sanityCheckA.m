% sanityCheckA(trainFunc,testFunc)
%
% sanityCheckA will check if the functions trainRegressor and testRegressor
...
% Inputs:
%
% trainFunc    to test your regressor code type: @trainRegressor
%
% testFunc     to test your regressor code type: @testRegressor
%
...
%
function sanityCheckA(trainFunc,testFunc)
%generate some data
trainData=rand(randi([90 110],1),3);
testData=rand(randi([90 110],1),2);
trainIn=trainData(:,1:2);
trainIn(:,1)=trainIn(:,1)+51.5;
trainIn(:,2)=trainIn(:,2)-0.2;
